...
public class MealTestData {
    public static final MatcherFactory<Meal> MATCHER = MatcherFactory.usingIgnoringFieldsComparator("users");
  //  public static final MatcherFactory<Meal> MATCHER = MatcherFactory.usingFieldsComparator("user");
