...
public class MealsUtil {
    ...
    private static List<MealTo> filteredByStreams(Collection<Meal> meals, LocalTime starTime, LocalTime endTime, int caloriesPerDay) {
...
//                      Collectors.toMap(Meal::getDate, Meal::getCalories, Integer::sum)
        ...
        return meals.stream()
                .filter(um -> TimeUtil.isBetweenHalfOpen(um.getDateTime().toLocalTime(), starTime, endTime))
