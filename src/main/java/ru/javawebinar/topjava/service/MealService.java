...
//        return repository.isBetweenHalfOpen(startDate, endDate, userId);
        return repository.isBetweenHalfOpen(getStartInclusive(startDate), getEndExclusive(endDate), userId);
    }
